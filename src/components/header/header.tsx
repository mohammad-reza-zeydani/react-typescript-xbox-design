                      ...
                      return (
                        <div
                          ...
                          <div className='flex py-5 px-2  items-center text-zinc-900 text-sm font-medium  border-t border-x border-dashed border-white hover:border-black hover:bg-neutral-200 transition-colors'>
                            ...
                            <h1 className='cursor-context-menu'>{btn.title}</h1>
                            {/* chevron-down-svg */}
                            <svg
                            ...
                            {btn.extraMenu === true && (
                              <div
                                  ...
                                  {btn.extraBtns?.map((b: TBtnObject) => {
                                    return (
                                      <div
                                        ...
                                        onMouseEnter={() =>
                                          setTitleName(b.btnsTitle)
                                        }
                                        className='flex items-center justify-between child:py-5 child:px-5'>
                                        {/* if we have the list of buttons inside our btnsTitle,dont consider title as link otherwise consider it as link */}
                                        {b.titleBtns.length !== 0 ? (
                                          <h1>{b.btnsTitle}</h1>
                                        ) : (
                                        ...
                                        {/* if the titleBtns have a list of buttons inside,show chevron right svg to show taht the title is for hovring not for clicking because it has extra menu */}
                                        {b.titleBtns.length !== 0 && (
                                          <div>
                                            {/* chevron right svg */}
                                            <svg
                                ...
                                <div className='flex flex-col'>
                                  {btn.extraBtns?.map((b: TBtnObject) => {
                                    return (
                                      //if titleName state involvs the name of the title inside b.btnsTitle show extra menu by hovring the title
                                      b.btnsTitle === titleName && (
                                        <a href='#' className='flex flex-col'>
                                          {/* the buttons inside our extra menu */}
                                          {b.titleBtns.map((t: string) => (
